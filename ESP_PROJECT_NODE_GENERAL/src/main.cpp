...
//Task taskDbRefresh(TASK_SECOND*1,TASK_FOREVER,&dbRefresh);
//Task taskSendToGUI(TASK_SECOND*1,TASK_FOREVER,&sendToGUI);
//UART handler func returns the msg from nucleo
...
//mesh.setDebugMsgTypes( ERROR | MESH_STATUS | CONNECTION | SYNC | COMMUNICATION | GENERAL | MSG_TYPES | REMOTE ); // all types on
  ...
  //userScheduler.addTask(taskDbRefresh);
  //userScheduler.addTask(taskSendToGUI);
  taskSendMessage.enable();
  //taskSendToGUI.enable();
